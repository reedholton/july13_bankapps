...
export default function Deposit() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Business rules (amount must be positive) are enforced server-side in
      // AccountService - whatever message it sends back is shown as-is here.
      setError(err instanceof ApiError ? err.message : 'Something went wrong')
      setSubmitting(false)
    }
  }
  ...
  if (status === 'loading') {
    return (
      <PassbookFrame trail={[{ label: 'Home', to: '/' }]} title="Deposit money">
